...
FOUNDERS = {
    'simon-nyborg': {
        'image': 'Simon Nyborg.png',
        'image_width': 800,
        'image_height': 800,
        'email': 'simonhn02@gmail.com',
        'linkedin': 'https://www.linkedin.com/in/simon-nyborg',
        'content': {
            'da': {
                'seo_title': 'Simon Nyborg | Datara',
                'meta_description': 'Mød Simon Nyborg, der arbejder med dataanalyse og automatisering hos Datara.',
                'name': 'Simon Nyborg',
                'role': 'Dataanalyse og automatisering',
                'bio': 'Simon arbejder med at gøre data og ny teknologi brugbare i praksis. Han er uddannet i Data Science and Management fra DTU og har flere års erfaring med dataanalyse og konsulentarbejde på miljøområdet.',
            },
            'en': {
                'seo_title': 'Simon Nyborg | Datara',
                'meta_description': 'Meet Simon Nyborg, who works with data analysis and automation at Datara.',
                'name': 'Simon Nyborg',
                'role': 'Data analysis and automation',
                'bio': 'Simon works with data analysis and automation in practice. He studied Data Science and Management at the Technical University of Denmark and has several years of experience in data analysis and environmental consultancy.',
            },
        },
    },
    'albert-koba': {
        'image': 'Albert Koba.jpg',
        'image_width': 646,
        'image_height': 646,
        'email': 'albert@analysekoebenhavn.dk',
        'linkedin': 'https://www.linkedin.com/in/albertkoba',
        'content': {
            'da': {
                'seo_title': 'Albert Koba | Datara',
                'meta_description': 'Mød Albert Koba, der arbejder med salg og forretningsudvikling.',
                'name': 'Albert Koba',
                'role': 'Salg og forretningsudvikling',
                'bio': 'Albert kombinerer erfaring med salg, dataanalyse og forretningsudvikling. Han har arbejdet med automatiseringer, der sparer tid, og med partnerskaber på tværs af B2B og B2C.',
            },
            'en': {
                'seo_title': 'Albert Koba | Datara',
                'meta_description': 'Meet Albert Koba, who works with sales and business development.',
                'name': 'Albert Koba',
                'role': 'Sales and business development',
                'bio': 'Albert combines experience in sales, data analysis and business development. He has worked with time-saving automation and partnerships across both B2B and B2C.',
            },
        },
    },
}
