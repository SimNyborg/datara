...
translations = {
    'da': {
        ...
        'services_subheading': 'Løsningerne tager udgangspunkt i jeres eksisterende arbejdsgange.',
    ...
    'en': {
        ...
        'services_subheading': 'The solutions are based on your existing workflows.',
